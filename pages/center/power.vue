    ...
    <div class="page">
      ...
      <h3 class="output">
        ...
        <span>
            ...
            <i
               class="iconfont icon-help el-popover__reference" aria-describedby="el-popover-2429" tabindex="0"></i>
          </span>
      </h3>
          ...
          <table>
            <thead>
              <tr>
                ...
                <td class="col-output">产出币量(BTC)</td>
                <td class="col-energy">耗电费用</td>
                <td class="col-manage">
                  管理费用(BTC)
                  <i class="iconfont icon-help el-tooltip item" aria-describedby="el-tooltip-8187" tabindex="0"></i>
                </td>
                <td class="col-actual">实际币量(BTC)</td>
