      ...
      <div class="header__inner">
        ...
        <div class="left text-right">
          <ul role="menubar" class="menu login el-menu--horizontal el-menu is-login">
            <nuxt-link role="menuitem" aria-haspopup="true" menu-trigger="hover" class="mine el-submenu" tabindex="0"
              tag="li" :to="$t(`root`) + '/'">
              ...
              <el-dropdown>
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item @click.native="changeLanguage('en')">
                    ...
                    <span>&nbsp;&nbsp;English</span></el-dropdown-item>
...
.app-container {
  ...
  #gn-header .menu-item.login, #gn-header .menu-item.register {
    padding-left: 10px;
    padding-right: 10px;
  }

  #gn-header .menu-item.login:focus, #gn-header .menu-item.login:hover, #gn-header .menu-item.register:focus, #gn-header .menu-item.register:hover {
    background-color: transparent !important;
  }
